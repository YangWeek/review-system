...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.SID = field.NewString(tableName, "s_id")
	_student.SName = field.NewString(tableName, "s_name")
	_student.SBirth = field.NewString(tableName, "s_birth")
	_student.SSex = field.NewString(tableName, "s_sex")
...
func (s *student) updateTableName(table string) *student {
	...
	s.SID = field.NewString(table, "s_id")
	s.SName = field.NewString(table, "s_name")
	s.SBirth = field.NewString(table, "s_birth")
	s.SSex = field.NewString(table, "s_sex")
...
func (s *student) fillFieldMap() {
	...
	s.fieldMap["s_id"] = s.SID
	s.fieldMap["s_name"] = s.SName
	s.fieldMap["s_birth"] = s.SBirth
	s.fieldMap["s_sex"] = s.SSex
}
