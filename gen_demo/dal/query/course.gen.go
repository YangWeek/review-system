...
func newCourse(db *gorm.DB, opts ...gen.DOOption) course {
	...
	_course.CID = field.NewString(tableName, "c_id")
	_course.CName = field.NewString(tableName, "c_name")
	_course.TID = field.NewString(tableName, "t_id")
...
func (c *course) updateTableName(table string) *course {
	...
	c.CName = field.NewString(table, "c_name")
	c.TID = field.NewString(table, "t_id")
...
func (c *course) fillFieldMap() {
	...
	c.fieldMap["c_name"] = c.CName
	c.fieldMap["t_id"] = c.TID
}
