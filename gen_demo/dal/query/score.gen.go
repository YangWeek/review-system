...
func newScore(db *gorm.DB, opts ...gen.DOOption) score {
	...
	_score.SID = field.NewString(tableName, "s_id")
	_score.CID = field.NewString(tableName, "c_id")
	_score.SScore = field.NewInt32(tableName, "s_score")
...
func (s *score) updateTableName(table string) *score {
	...
	s.CID = field.NewString(table, "c_id")
	s.SScore = field.NewInt32(table, "s_score")
...
func (s *score) fillFieldMap() {
	...
	s.fieldMap["c_id"] = s.CID
	s.fieldMap["s_score"] = s.SScore
}
