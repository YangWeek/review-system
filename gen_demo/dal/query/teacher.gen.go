...
func newTeacher(db *gorm.DB, opts ...gen.DOOption) teacher {
	...
	_teacher.TID = field.NewString(tableName, "t_id")
	_teacher.TName = field.NewString(tableName, "t_name")
...
func (t *teacher) updateTableName(table string) *teacher {
	...
	t.TName = field.NewString(table, "t_name")
